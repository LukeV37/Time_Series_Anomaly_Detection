...
def trim_edges(
    ...
    *,
    ...
    If ``run_specific`` is provided, a matching ``run_number`` can override the
    default trim values for the current input only.
    ...
    Args:
        ...
        run_number:   Optional runtime run number for the current input.
